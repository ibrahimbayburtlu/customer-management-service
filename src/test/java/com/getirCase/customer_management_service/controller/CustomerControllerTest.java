...
class CustomerControllerTest {
  ...
  void setUp() {
    ...
    request =
        new CustomerRequest(
            "ibrahim",
            "bayburtlu",
            "ibrahimbayburtlu5@gmail.com",
            "5061225291",
            "merkez mahallesi kavaklı sokak",
  ...
  void testGetCustomer() throws Exception {
    ...
    mockMvc
        .perform(get(ApiEndpoints.CUSTOMER_BASE + ApiEndpoints.GET_CUSTOMER, 1L))
  ...
  void testGetCustomerNotFound() throws Exception {
    ...
    mockMvc
        .perform(get(ApiEndpoints.CUSTOMER_BASE + ApiEndpoints.GET_CUSTOMER, 99L))
  ...
  void testCreateCustomer() throws Exception {
    ...
    mockMvc
        .perform(
            post(ApiEndpoints.CUSTOMER_BASE + ApiEndpoints.CREATE_CUSTOMER)
                .contentType("application/json")
                .content(
                    "{\"name\":\"ibrahim\",\"surname\":\"bayburtlu\",\"email\":\"ibrahimbayburtlu5@gmail.com\",\"phoneNumber\":\"5061225291\",\"address\":\"merkez mahallesi kavaklı sokak\"}"))
  ...
  void testCreateCustomerBadRequest() throws Exception {
    request =
        new CustomerRequest("", "", "", "", "merkez mahallesi kavaklı sokak", CustomerTier.REGULAR);
  ...
  void testDeleteCustomer() throws Exception {
    mockMvc
        .perform(
            delete(ApiEndpoints.CUSTOMER_BASE + ApiEndpoints.DELETE_CUSTOMER, 1L)
  ...
  void testDeleteCustomerNotFound() throws Exception {
    ...
    mockMvc
        .perform(
            delete(ApiEndpoints.CUSTOMER_BASE + ApiEndpoints.DELETE_CUSTOMER, customerId)
                .contentType(MediaType.APPLICATION_JSON))
  ...
  void testDeleteCustomerBadRequest() throws Exception {
    ...
    mockMvc
        .perform(
            delete(ApiEndpoints.CUSTOMER_BASE + ApiEndpoints.DELETE_CUSTOMER, invalidCustomerId)
                .contentType(MediaType.APPLICATION_JSON))
  ...
  void testUpdateCustomerSuccess() throws Exception {
    ...
    mockMvc
        .perform(
            put(ApiEndpoints.CUSTOMER_BASE + ApiEndpoints.UPDATE_CUSTOMER, customerId)
                .contentType(MediaType.APPLICATION_JSON)
  ...
  void testUpdateCustomerTierSuccess() throws Exception {
    ...
    mockMvc
        .perform(
            patch(ApiEndpoints.CUSTOMER_BASE + ApiEndpoints.UPDATE_TIER, customerId)
